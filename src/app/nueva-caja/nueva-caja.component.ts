...
import {DbManagerFirestoreService, MCaja, MetaLote} from '../db-manager-firestore.service';
...
export class NuevaCajaComponent implements OnInit, OnDestroy {
  ...
  constructor(public estructura: ModelCajasService, public db: DbManagerService,
              private tools: ToolsService, public fs: DbManagerFirestoreService) {
  ...
  iniciarRegistro() {
    ...
    //
    this.currentLote.id = this.fs.getUniqId();
