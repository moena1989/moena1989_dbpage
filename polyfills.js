...
function patchEventTarget(_global, apis, patchOptions) {
    ...
    var globalZoneAwareCallback = function (event) {
        ...
        if (tasks) {
            // invoke all tasks which attached to relojData target with given event.type and capture = false
 ...
 *      file.
 *
 * The relojData setup is for so-called "evergreen" browsers; the last versions of browsers that
...
module.exports = __webpack_require__(/*! E:\Gc\Proyectos\M89\moena1989_dbpage\src\polyfills.ts */"./src/polyfills.ts");
